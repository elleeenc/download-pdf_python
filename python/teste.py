...
df = pd.DataFrame(tabula.read_pdf(path, pages = '81,82,83,84,85,86,87,88', lattice  = False))
print(df)

df.to_csv('/Users/mrock/Desktop/python/teste.csv', index = True, encoding="utf-8")